              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 sticky top-8 animate-fade-in-up" style={{ animationDelay: '0.8s', borderColor: 'rgba(81, 12, 116, 0.2)', borderWidth: '1px' }}>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid #510c74/10' }}>
                    ...
                    <span className="font-semibold flex items-center" style={{ color: '#510c74' }}>
                ...
                <div className="mt-8 p-6 rounded-xl" style={{ background: 'rgba(81, 12, 116, 0.05)', borderColor: '#510c74/10', borderWidth: '1px' }}>
                  <div className="flex items-center mb-3">
                    <Heart className="w-5 h-5 mr-2" style={{ color: '#510c74' }} />
                    <h3 className="font-semibold" style={{ color: '#510c74' }}>Free Shipping</h3>
                  </div>
                  <p className="text-sm leading-relaxed" style={{ color: '#240334', opacity: 0.8 }}>
                    ...
                    <span className="font-medium" style={{ color: '#510c74' }}> Express delivery available!</span>
                  </p>
                </div>
              </div>
            </div>
